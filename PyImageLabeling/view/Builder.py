...
class Builder:
    ...
    def build_left_layout(self):
        ...
        for category in self.view.config["buttons"]:
            ...
            #frame.setStyleSheet(Utils.get_style_css())
    ...
    def build_right_layout(self):
        ...
        self.view.main_layout.addWidget(self.right_layout_container, 0, Qt.AlignmentFlag.AlignTop)  # Set stretch factor for image area
        self.view.main_layout.addStretch(1)
